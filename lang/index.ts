...
const json: JSON = {
  en: {
    title: 'Hey <%><span class="rotated-hand" i-noto:waving-hand></span></%>, I am Simon He, currently a front-end programmer. My hobbies include watching animation, playing basketball, watching some mystery dramas, and werewolf, lived in <%><span class="i-mi:location"></span></%>Shanghai <%><span class="i-openmoji:flag-china"></span></%>',
    contents: [
